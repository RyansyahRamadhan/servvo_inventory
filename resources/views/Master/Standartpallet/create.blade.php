        ...
        <div class="container-fluid px-4">
            <div class="card mb-4">
                <div class="card-header">
                    ...
                    Tambah Standar Pallet
                </div>
                <div class="card-body">
                    <form action="{{ route('standartpallet.store') }}" method="POST">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="kapasitas" class="form-control" step="0.01" required>
                        </div>
                        <div class="mb-3">
                            <label for="isi_per_pallet" class="form-label">Isi Per Pallet (dus/pollybox)</label>
                            <input type="number" name="isi_per_pallet" class="form-control" step="0.01" required>
                        </div>
                        <div class="mb-3">
                            <label for="isi_dus_per_pallet" class="form-label">Isi Dus/Pollybox Per Pallet</label>
                            <input type="number" name="isi_dus_per_pallet" class="form-control" step="0.01" required>
                        </div>
                        <div class="mb-3">
                            <label for="berat_dus" class="form-label">Berat Dus (kg)</label>
                            <input type="number" name="berat_dus" class="form-control" step="0.01" required>
                        </div>
                        <div class="mb-3">
                            <label for="berat_per_pallet" class="form-label">Berat Per Pallet (kg)</label>
                            <input type="number" name="berat_per_pallet" class="form-control" step="0.01" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="nama_lorong" class="form-control" required>
                                ...
                                @foreach($lorong as $item)
                                    <option value="{{ $item->nama_lorong }}">{{ $item->nama_lorong }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="mb-3">
