...
<div class="container-fluid px-4">
  <h3 class="mt-4">History Barang</h3>

  <form class="row g-2 mb-3" method="get">
    <div class="col-auto">
      <input type="text" name="q" value="{{ $q }}" class="form-control form-control-sm" placeholder="Kode / Nama Barang">
    </div>
    <div class="col-auto">
  ...
  <div class="table-responsive">
    <table class="table table-sm table-striped align-middle">
      <thead>
        <tr>
          <th>Tanggal</th><th>Tipe</th><th>Kode</th><th>Nama</th>
          <th>Rak Asal</th><th>Rak Tujuan</th>
          <th class="text-end">Qty</th><th>Dokumen</th><th>User</th>
        </tr>
      </thead>
      <tbody>
        @forelse($data as $row)
